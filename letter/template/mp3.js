var MP3 = {
  make: function () {
    ...
    mp3.play = function () {
      ...
      $('.spinner').show();
      $('.mp3-ul li:lt(90)').removeClass('blueyellow');
      $('.mp3-ul li:eq(' + mi + ')').addClass('blueyellow');
      $('.pause').html('☆暂停');
    ...
    mp3.one=function(){
        if(mp3one){ mp3one = false; $('.order').html('☆单曲'); }
        else { mp3one = true; $('.order').html('☆顺序'); }
    }
